...
import certificado from '../assets/Certificado-Español-2000.png';
...
const Home = () => {
  ...
  const handleWhatsAppClick = () => {
    const message = 'Hola, necesito ayuda con un presupuesto';
    const phoneNumber = '5493515504955'; // Replace with the recipient's phone number
  ...
  async function fetch() {
    ...
    doc.setFontSize(20);
    doc.text(myData.date, 350, 390, { align: 'center' });
    doc.setFont('AlexBrush');
    doc.save(`Certificado ${myData.username}`);
  }
  ...
  return (
    <div className="bg-gradient-to-r from-purple-900 to-indigo-900 min-h-screen flex flex-col items-center justify-center mt-[-40px]">
      ...
      ¡BIENVENIDO AL MUNDO DEL PORCELANATO LÍQUIDO Y PISOS 3D!
      </h1>
      <div className='flex flex-col md:flex-row md:space-x-12'>
        <button className="bg-gradient-to-r from-purple-500 to-sky-500 hover:bg-fuchsia-900 text-white font-bold py-7 px-12 rounded-full w-full mb-4 text-xl"
...
Durante el curso, aprenderás todas las técnicas fundamentales y avanzadas del porcelanato líquido, desde la preparación de superficies hasta la aplicación de diseños en 3D. Explorarás una amplia gama de temas, incluyendo la selección adecuada de materiales, la mezcla y aplicación precisa del porcelanato líquido, y cómo crear impresionantes diseños tridimensionales que cautiven la vista.
    ...
    <Button
      variant="contained"
      style={{ backgroundColor: '#4caf50', marginLeft:"20px", fontSize: '18px' }} // Color rojo fuerte
