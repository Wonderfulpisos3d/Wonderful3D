...
const FlakesComponent = () => {
  ...
  const calcularResultado = () => {
    ...
    if (selectedFlakesOption === "Partial Flakes"){
      cantidad = Math.ceil(squareFeet * 0.01)
      primer = Math.ceil(squareFeet * 0.00769)
      polyaspartic = Math.ceil(squareFeet * 0.01)
      proteccion = Math.ceil(squareFeet * 0.1)

      let resultadoCalculado = (
        <div>
          Para tu proyecto de {squareFeet} square feet:
          <br />
          Se necesitan {cantidad} libras de flakes
          <br />
          Se necesitan {primer} galones de epoxy primer WF52
          <br />
          Se necesitan {polyaspartic} galones de polyaspartic
        </div>
      );
      ...
      let mensajito = `Para tu proyecto de ${squareFeet} square feet: Se necesitan ${cantidad} libras de flakes, ${primer} galones de epoxy primer WF52, ${polyaspartic} galones de polyaspartic.`;
      let mensajitoProteccion = `Para tu proyecto de ${squareFeet} square feet: Se necesitan ${cantidad} libras de flakes, ${primer} galones de epoxy primer WF52, ${polyaspartic} galones de polyaspartic.`
      ...
      cantidad = Math.ceil(squareFeet * 0.167)
      primer = Math.ceil(squareFeet * 0.00769)
      polyaspartic = Math.ceil(squareFeet * 0.01)
      proteccion = Math.ceil(squareFeet * 0.002857)
...
export default FlakesComponent;