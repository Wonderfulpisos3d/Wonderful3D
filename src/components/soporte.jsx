...
function SupportForm() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await fetch('https://us-central1-fir-proyect-7e9ea.cloudfunctions.net/sendHelpEmail', {
        method: 'POST',
        headers: {
  ...
  const envioCorrecto = () => {
    MySwal.fire({
      ...
      if (result.isConfirmed) {
        window.location.href = '/home'; // <-- aquí puedes especificar la ruta de inicio
      }
    });
  };
