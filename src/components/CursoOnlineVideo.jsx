  ...
  return (
    <div className="video-super min-h-screen pt-0 bg-primary-800">
      <div className="video-page text-center max-w-3xl mx-auto p-4 bg-primary-800">
        <h1 className="mb-4 text-purple-200 text-3xl font-semibold font-montserrat">
        Curso Online - Wonderful 3D - Porcelanato Liquido y Pisos 3D
        </h1>
        {videos.map((video) => (
  <div key={video.id} className="grid grid-cols-1 md:grid-cols-12 gap-2 my-4 md:my-8">
